...
int main(int argc, const char *argv[]) {
  ...
  // void* handle =
  // dlopen("/Volumes/my/src/dyld/build/Debug/dsc_extractor.bundle", RTLD_LAZY);
  void *handle = dlopen("/Applications/Xcode.app/Contents/Developer/Platforms/"
  ...
  if (proc == NULL) {
    fprintf(stderr, "dsc_extractor.bundle did not have "
